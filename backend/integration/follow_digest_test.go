...
// carried overflow (#222), the "you're going" marking and the Register call to
// action (#223), and the Unsubscribe link (#224). Each arrives with its own
// tests, and a test here asserting more than what is built would be asserting a

> **EDICIÓN PROVISIONAL.** Este texto no es asesoría legal y no ha sido revisado por un abogado. Cada marcador entre corchetes — `[DENOMINACIÓN SOCIAL]`, `[RUC]`, `[correo PDP]`, `[DIRECCIÓN]` — se completa con el texto legal definitivo antes de la salida a producción, y solo entonces se publica la primera Versión de la Política real.

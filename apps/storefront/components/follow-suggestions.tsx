...
import type { FollowSuggestions, SessionOutcome } from "@/lib/customer-session";
 ...
 * the ones they do (#231, parent #229, ADR 0031).
 *
          ...
          {tags.map(({ tag }) => {
            ...
            return (
              <span
                ...
                className="border-input bg-background inline-flex items-center rounded-full border"
              >
                ...
                {!tag.curated ? (
                  ...
                  // and is owed the reason here more than in the list above,

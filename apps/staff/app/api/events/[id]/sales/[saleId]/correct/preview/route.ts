...
// POST previews a Sale Correction (#352, ADR 0050): the same body as the
// commit, forwarded verbatim to the Go preview endpoint, whose verdict — the
// import preview's shape, one row — comes back as is and writes nothing. The

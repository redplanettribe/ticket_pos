...
**Online Sales only, from this deploy onward.** A door sale's or Sale Import's buyer is a name
somebody else typed and often is not attending; existing Sales are not backfilled.

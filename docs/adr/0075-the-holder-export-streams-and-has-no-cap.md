...
`TestSalesExportPerTicketSheetIsCellIdenticalToMain` pins the per-Ticket sheet cell by cell against the file main wrote, an empty text Answer and a date before 1900 included.
